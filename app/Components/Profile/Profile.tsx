...
function Profile() {
  ...
  return (
    <div>
      <div
        className="h-[60px] ml-[12px] px-2 py-4 flex items-center gap-3 bg-[#E6E6E6]/20 rounded-[0.8rem]
        hover:bg-[#E9E9E9]/50 transition duration-300 ease-in-out cursor-pointer border-2 border-transparent hover:border-2 hover:border-white"
